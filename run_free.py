"""Free-source news scraper entry point.

Calls five open-access energy & geopolitical news scrapers, merges results,
deduplicates by URL, sorts by publication date (newest first), and writes
free_news_output.csv.
